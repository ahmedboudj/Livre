...
if($book) {
  ...
  <div class="row">
      ...
      <div class="col-6">
        ...
        <div class="card mb-3">
          <div class="card-header bgBlue text-center">
            <h5 class="card-title">Emprunteur </i></h5>
          </div>
          <div class="card-body">
            <ul class="list-group list-group-flush">
              <li class='list-group-item'><span class="font-weight-bold">Prénom : </span><?php echo $book->getUser()->getprenom(); ?></li>
              ...
              <li class='list-group-item'><span class="font-weight-bold">Ville : </span><?php echo $book->getUser()->getAdresse(); ?></li>
